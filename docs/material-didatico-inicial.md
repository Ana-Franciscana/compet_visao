# Material Didático Inicial - PNEUMOVISION
...
- apresentar a visão geral da solução e do contexto de uso;
- desenvolver familiaridade com os conceitos e processos envolvidos;
- orientar a execução de atividades práticas da etapa inicial;
- preparar os participantes para evoluir em etapas posteriores do programa.
...
## 4. Competências esperadas

Ao final da etapa introdutória, espera-se que o participante seja capaz de:

- reconhecer a proposta e o objetivo da solução;
- compreender a lógica geral do treinamento;
- acompanhar os roteiros e cronogramas das atividades;
- aplicar os aprendizados em exercícios e tarefas práticas;
- manter uma visão clara dos próximos passos do programa.

## 5. Estrutura do conteúdo

O material está organizado em três blocos principais:

1. fundamentos e visão geral da solução;
2. roteiro da fase inicial de treinamento;
3. acompanhamento e consolidação do aprendizado.

## 6. Boas práticas de aprendizado

- estudar em sequência os módulos e materiais;
- registrar dúvidas e tópicos para revisão;
